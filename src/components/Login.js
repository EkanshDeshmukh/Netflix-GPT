...
const Login = () => {
    ...
    return (
        <div className='relative text-white font-semibold'>
            ...
            <form className='w-3/12 h-fit rounded-md flex flex-col  absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black  bg-opacity-70 '>
                ...
                />
                <button className="p-4 my-5 bg-red-700 font-bold text-lg w-full rounded-lg">{isSignIn ? "Sign in" : "Sign up"} </button>
